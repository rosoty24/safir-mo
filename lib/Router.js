Router.configure({
    ...
    waitOn : function () {
        return [TAPi18n.subscribe("brand")];
    }
...
Router.route('/',{
    ...
    name:'home',
    waitOn : function () {
        return [TAPi18n.subscribe("productsHome",-1),TAPi18n.subscribe("list_product"),Meteor.subscribe("banner")];
    },
    //fastRender: true
});
...
Router.route('/category/:id',{
    ...
    data: function() {
        ...
        if(l==null){
            ...
            var l=categories.findOne({"i18n.en.title": { $regex: new RegExp("^" + title, "i") } });
        }
        console.log('l='+l);    
        var parent=l._id;
        //=========makara=============
...
Router.route('/favorite', {
    ...
    template:'listproducts',
    waitOn : function () {
        //return [TAPi18n.subscribe("products"),Meteor.subscribe("favorite")];

        //return [TAPi18n.subscribe("products",-1),Meteor.subscribe("favorite")]; 
        return [TAPi18n.subscribe('categories'),TAPi18n.subscribe('products', -1),TAPi18n.subscribe('parent_tags'),TAPi18n.subscribe('tags'),TAPi18n.subscribe('favorite')];
